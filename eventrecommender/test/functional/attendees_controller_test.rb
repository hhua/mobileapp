...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post :create, attendee: { attending: @attendee.attending, event_id: @attendee.event_id, rating: @attendee.rating, saved: @attendee.saved, user_id: @attendee.user_id }
    end
  ...
  test "should update attendee" do
    put :update, id: @attendee, attendee: { attending: @attendee.attending, event_id: @attendee.event_id, rating: @attendee.rating, saved: @attendee.saved, user_id: @attendee.user_id }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
